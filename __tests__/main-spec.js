...
it ('should get a generateMultiplicationTable String when give two multipliers  ', () => {
    const reString='2*1=2 2*2=4 \n'+'3*1=3 3*2=6 3*3=9 \n'+'4*1=4 4*2=8 4*3=12 4*4=16 \n';
    expect(generateMultiplicationTable(2, 4)).toBe(reString);
});
it ('should get a generateMultiplicationTable String when give two multipliers  ', () => {
    const reString='2*1=2 2*2=4 \n'+'3*1=3 3*2=6 3*3=9 \n'+'4*1=4 4*2=8 4*3=12 4*4=16 \n';
    expect(getMultiplicationTable(2, 4)).toBe(reString);
});
it ('should get a generateMultiplicationTable String when give one valid multipliers and a not valid multipliers  ', () => {
